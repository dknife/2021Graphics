...
class MyGLWidget(QOpenGLWidget):
    ...
    def set_nSub(self, val):
        self.nSub = int(val /10)
        self.update()
...
class MyWindow(QMainWindow):
    ...
    def __init__(self, title = ''):
        ...
        nSub_slider = QSlider(Qt.Horizontal)
        gui_layout.addWidget(nSub_slider)
        nSub_slider.valueChanged.connect(lambda val: self.glWidget.set_nSub(val))

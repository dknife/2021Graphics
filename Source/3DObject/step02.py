...
class MyGLWidget(QOpenGLWidget):
    ...
    def paintGL(self):
        ...
        glColor3f(0, 0, 1)
        glLineWidth(3)
        draw_triangle(self.verts[0], self.verts[2], self.verts[1])
        draw_triangle(self.verts[1], self.verts[2], self.verts[3])
        draw_triangle(self.verts[3], self.verts[2], self.verts[0])
        draw_triangle(self.verts[0], self.verts[1], self.verts[3])
        glLineWidth(1)
